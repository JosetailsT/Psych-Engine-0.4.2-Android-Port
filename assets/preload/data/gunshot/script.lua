...
function opponentNoteHit()
    ...
    if luckyRoll <= 30 and mustHitSection == true and getProperty("dad.curCharacter") == 'pico-SAVEHIM' and getProperty('dad.animation.curAnim.name') == 'idle' then
        triggerEvent('Change Character', 'dad', 'pico')
    elseif luckyRoll > 30 and mustHitSection == true and getProperty("dad.curCharacter") == 'pico' and getProperty('dad.animation.curAnim.name') == 'idle' then
